...
// ----------------- Fix for LANG-440 ---------------------- END ---------------
    ...
    static class DateIterator implements Iterator<Calendar> {
        private final Calendar mEndFinal;
        private final Calendar mSpot;
        ...
        DateIterator(final Calendar startFinal, final Calendar endFinal) {
            super();
            this.mEndFinal = endFinal;
            mSpot = startFinal;
            mSpot.add(Calendar.DATE, -1);
        }
        ...
        public Calendar next() {
            if (mSpot.equals(mEndFinal)) {
                throw new NoSuchElementException();
            }
            mSpot.add(Calendar.DATE, 1);
            return (Calendar) mSpot.clone();
        }
